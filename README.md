...
- `/docs` - Documentation, including demo videos and photos.
  - [Watch Demo Video](https://www.youtube.com/shorts/B2bcqpg_jws)
...
9. **wheels:** 4.4x2 cm rubbered wheels for high grip and 1 castel wheel
10. **Misc:** 1x Push Button, 1x 10k Resistor (for button pull-down), Jumper wires, pins for holding components on pcb, Breadboard/PCB(optional).
...
1. Open this folder in VS Code with the **PlatformIO** extension installed, you can also use the Arduino IDE. for Arduino IDE select the correct board and port from the tools menu. Don't forget to install Esp32 core for Arduino IDE, from the boards manager, esp32 by Espressif systems.
